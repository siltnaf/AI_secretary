...
// #endif
    ...
    SecretaryApp *secretary = new SecretaryApp();
    assert(secretary != nullptr && "Failed to create secretary");
    assert((phone->installApp(secretary) >= 0) && "Failed to install secretary");

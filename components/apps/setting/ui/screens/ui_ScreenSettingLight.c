...
lv_obj_set_height( ui_PanelScreenSettingLightSwitch, 100);
lv_obj_set_width( ui_PanelScreenSettingLightSwitch, lv_pct(90));
lv_obj_set_x( ui_PanelScreenSettingLightSwitch, 20 );
...
lv_obj_set_style_text_font(ui_LabelPanelScreenSettingLightSwitch, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_SliderPanelScreenSettingLightSwitch1 = lv_slider_create(ui_PanelScreenSettingLightSwitch);
lv_obj_set_width( ui_SliderPanelScreenSettingLightSwitch1, 200);
lv_obj_set_height( ui_SliderPanelScreenSettingLightSwitch1, 10);
lv_obj_set_x( ui_SliderPanelScreenSettingLightSwitch1, 70 );
...
ui_SpinnerScreenSettingLight = lv_spinner_create(ui_ScreenSettingLight,300,90);

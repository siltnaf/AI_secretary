...
public:
    ...
    static void onSdCardBackEventCallback(lv_event_t * e);
    static void onSdCardFormatEventCallback(lv_event_t * e);
    static void sdFormatTask(void *arg);
    static void sdFormatFinished(void *arg);
    static void onSdCardFormatCompleteEventCallback(lv_event_t * e);
...
private:
    ...
    static void onContentUrlOpenEventCallback(lv_event_t * e);
    static void onContentUrlSaveEventCallback(lv_event_t * e);
    static void onContentUrlCancelEventCallback(lv_event_t * e);
    static void onNetworkingOpenEventCallback(lv_event_t * e);
    static void onNetworkingBackEventCallback(lv_event_t * e);
    static void onNetworkingWifiOpenEventCallback(lv_event_t * e);
    static void onNetworkingWifiBackEventCallback(lv_event_t * e);
    static void onEpaperToggleEventCallback(lv_event_t * e);
    static void onEpaperCycleEventCallback(lv_event_t * e);
    static void onEpaperAudioTestEventCallback(lv_event_t * e);
    static void onEpaperAboutEventCallback(lv_event_t * e);
    static void onSdCardOpenEventCallback(lv_event_t * e);
    static void onSdCardFormatConfirmEventCallback(lv_event_t * e);

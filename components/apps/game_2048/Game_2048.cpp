...
#define MUSIC_WEAK              BSP_SD_MOUNT_POINT MUSIC_DIR "/weak.mp3"
#define MUSIC_NORM              BSP_SD_MOUNT_POINT MUSIC_DIR "/normal.mp3"
#define MUSIC_GOOD              BSP_SD_MOUNT_POINT MUSIC_DIR "/good.mp3"
#define MUSIC_EXCL              BSP_SD_MOUNT_POINT MUSIC_DIR "/excellent.mp3"
...
bool Game2048::init(void)
{
    ...
    if (bsp_extra_file_instance_init(BSP_SD_MOUNT_POINT MUSIC_DIR, &_file_iterator) != ESP_OK) {
